...
nuke.pluginAddPath('//tls-storage02/3D3/COMPOSITING/.nuke/gizmos')
...
#Add pixelSort submenu
nuke.menu('Nodes').addCommand('Filter/PixelSort', "nuke.createNode('PixelSort.gizmo')", icon='PixelSort.png')

#Add pixelSort submenu
nuke.menu('Nodes').addCommand('Filter/Hue_Mask', "nuke.createNode('Hue_Mask.gizmo')", icon='Hue_Mask.png')


#Add Crypto_Auto submenu
nuke.menu('Nodes').addCommand('Filter/Crypto_Auto', "nuke.createNode('Crypto_Auto.nk')")

#Add P_Matte_Auto submenu
nuke.menu('Nodes').addCommand('Filter/P_Matte_Auto', "nuke.createNode('P_matte_Auto.nk')")
...
toolbar=nuke.menu("Nodes")
menu = toolbar.addMenu("Tractor", "TractorRenderSpool.png",index=-1)
