...
from tractor.packages.six.moves.http_client import IncompleteRead as httplib_IncompleteRead
...
class StandardError(HTTPError):
    """Raised when passing a standard error."""
