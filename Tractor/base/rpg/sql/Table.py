...
from tractor.base.rpg.sql.Fields import ObjTypeField, AutoIncField
...
class Table(object):
    ...
    def addField(self, field, obj=None, prepend=False):
        ...
        if field.member in self.member2field:
            raise FieldExists("a Field object for member '%s' already exists." % field.member)
...
def testTable():
    ...
    from tractor.base.rpg.sql.Fields import VarCharField, IntField
    from tractor.base.rpg.sql.DBObject import DBObject
