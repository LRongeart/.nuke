...
from tractor.base.rpg import listutil
from tractor.base.rpg import StringUtilError
...
def file2str(filename, doraise=True):
    try:
        ...
        if doraise:
            raise StringUtilError(f"file2str(): can't handle file {filename}")
        else:
            return None
...
# aliased for backwards compatibility
from tractor.base.unitutil import formatHertz, formatBytes
